...
import { ArrowRight, Check, ChefHat, Utensils, Calculator, Clock } from "lucide-react"
    ...
    return (
        <div className="flex flex-col min-h-screen">
            <header className="px-4 lg:px-6 h-14 flex items-center border-b">
                ...
                {/* Mobile Menu Toggle */}
                <button className="ml-auto sm:hidden" onClick={() => setMenuOpen(!menuOpen)}>
                        ...
                        <div className="flex flex-col items-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                                    Personalized meal plans tailored to your goals. Your personal chef and nutritionist, just a click away.
                                </p>
                            </div>
                    ...
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <Card>
                                ...
                                <CardContent>
                                    <p className="text-muted-foreground">Tailored to your goals: maintenance, weight loss, or weight gain</p>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <p className="text-muted-foreground">All the necessary calculations done for you</p>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <p className="text-muted-foreground">Removes stress and saves time in meal planning</p>
                                </CardContent>
                            </Card>
                        </div>
                    </div>
                    ...
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <Card>
                                ...
                                <CardContent>
                                    <p className="text-muted-foreground">Choose between maintenance, weight loss, or weight gain</p>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <p className="text-muted-foreground">Select from a variety of delicious, healthy options</p>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <p className="text-muted-foreground">Receive a varied and nutritious meal plan tailored just for you</p>
                                </CardContent>
                            </Card>
                        </div>
                    </div>
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <Card>
                                <CardContent className="pt-6">
                                    <p className="mb-4 text-muted-foreground">"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam nec pulvinar neque, sed rutrum diam. Donec suscipit risus quam, a."</p>
                    ...
                    <div className="container px-4 md:px-6">
                        <div className="flex flex-col items-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                                    Join MealWell today and experience personalized nutrition at your fingertips.
                                </p>
                            </div>
                            <div className="space-x-4">
            ...
            <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
                <p className="text-xs text-muted-foreground">© 2024 MealWell. All rights reserved.</p>
